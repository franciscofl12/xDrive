            ...
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        ...
                        <h1 class="font-bold text-3xl mb-5 text-gray-900">Thanks for signing up!</h1>
                        <p class="mb-5">Before getting started, could you verify your email address by clicking on the
