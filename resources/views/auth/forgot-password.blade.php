            ...
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <a href="{{url('/')}}"><img src="../resources/img/logobigger.png" ></a>
                        <h1 class="font-bold text-3xl mb-5 text-gray-900">Forgot your password? No problem.</h1>
                        <p class="mb-5">Just let us know your email address and we will email you a password reset link that will
                    ...
                    <div>
                                ...
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <x-input id="email"
                                                 ...
                                                 placeholder="johnsmith@example.com" type="email" name="email"
                        ...
                        <form method="POST" action="{{ url('/') }}">
                            @csrf
                            <div class="flex -mx-2 grid place-items-center">
                                <div class="w-1/3 px-2 mb-5 grid place-items-center">
                                    <button
                                        class="block w-full max-w-xs mx-auto bg-gray-900 hover:bg-gray-400 focus:bg-gray-700 text-white rounded-lg px-2 py-2 font-semibold">
                                        Back Home
                                    </button>
                                </div>
                            </div>
